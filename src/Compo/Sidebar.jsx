    ...
    return (
        <div className='w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex'>
            <div className="bg-[#121212] h-[15%] rounded flex flex-col justify-around">
                <div onClick={()=>navigate('/')} className="flex items-center gap-3  pl-8 p-4  cursor-pointer">
                    <img src={assets.home_icon} className='w-6' alt="" />
                    <p className='font-bold' >Home</p>
                </div>
                <div className="flex items-center gap-3 pl-8 p-4 cursor-pointer">
                ...
                <div className="bg-[#121212] h-[85%] rounded">
                    ...
                    <div className="p-4 bg-[#242424] m-2 rounded font-semibold flex-col items-start justify-start gap-1 pl-4">
                        <h1>Lets find someone producate</h1>
                        <p className='font-light'>iwe will keep you update on new episode</p>
